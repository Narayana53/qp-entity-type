...
const init = async ({ config }) => {
  ...
  logger.info('Swagger URL: http://' +  app.config.HOST + ':'+ app.config.PORT + '/documentation');
  logger.info('Check server status URL: http://' +  app.config.HOST + ':'+ app.config.PORT + '/status');
